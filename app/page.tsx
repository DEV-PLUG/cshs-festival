...
export default function Home() {
  ...
  return (
    <div>
      ...
      {state === 2 && (
        <div className="fixed top-1/2 left-1/2 -translate-y-1/2 -translate-x-1/2 items-center justify-center p-5 bg-gray-100 rounded-2xl w-[400px]">
          <video width={400} height={400} controls src={'data:video/mp4;base64,' + videoData}></video>
